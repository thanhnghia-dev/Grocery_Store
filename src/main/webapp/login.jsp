                    ...
                    <div class="col-md-7 col-lg-6 col-md-offset-3">
                        ...
                        <div class="signin-container">
                            <form action="login" name="frm-login" method="post">
                                ...
                                %>
                                <p class="form-row">
                                    <label for="fid-name"><strong>Email / Số điện thoại </strong><span class="requite">*</span></label>
                                    <input type="text" id="fid-name" name="email" value="<%= request.getParameter("email")!= null ? request.getParameter("email") : ""%>" placeholder="Email / Số điện thoại" class="txt-input" required>
                                </p>
                                <p class="form-row">
                                ...
                                <p class="form-row">
                                    <a href="forgot-pass.jsp" class="link-to-help">Quên mật khẩu?</a>
                                </p>
